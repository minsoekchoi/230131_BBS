...
<script type="text/javascript">
	...
	function comment_go(f) {
		f.action = "${pageContext.request.contextPath}/MyController?cmd=c_write";
		f.submit();
	}
	function comment_del(f) {
		f.action = "${pageContext.request.contextPath}/MyController?cmd=c_delete";
		f.submit();
	}
</script>
</head>
			...
			<tbody>
				...
				<tr>
					...
					<c:choose>
						...
						<c:otherwise>
							<td>
								<a href="view/down.jsp?path=upload&f_name=${bvo.f_name}"><img src="upload/${bvo.f_name}" style="width: 80px"></a><br>
								 ${bvo.f_name}								
							</td>
						</c:otherwise>							 	
					</c:choose> 
